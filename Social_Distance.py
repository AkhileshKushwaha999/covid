    ...
    #=================================================================            	
        ...
        for idx, box in centroid_dict.items():  # dict (1(key):red(value), 2 blue)  idx - key  box - value
            if idx in red_zone_list:   # if id is in red zone list
                cv2.rectangle(img, (box[2], box[3]), (box[4], box[5]), (255, 0, 0), 1) # Create Red bounding boxes  #starting point, ending point size of 2
            else:
        ...
        cv2.putText(img, text, location, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (246,86,86), 1, cv2.LINE_AA)  # Display Text
...
def YOLO():
    ...
    out = cv2.VideoWriter(
            "Test_2_V_output.avi", cv2.VideoWriter_fourcc(*"MJPG"), 10.0,
